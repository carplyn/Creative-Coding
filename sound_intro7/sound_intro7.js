...
function preload() {
  ...
  myFont = loadFont("data/bianzhidai_noBG-Cube.otf");
    ...
    function setup() {
      ...
      osc = new p5.Oscillator('triangle'); // can be 'sine', 'triangle', 'sawtooth', 'square'
...
function draw_2() {
    ...
    for (let i = 0; i < 5; i++) {
        ...
        let r = random(0.2, 40); // Random radius for the star, smaller values for more distant stars
