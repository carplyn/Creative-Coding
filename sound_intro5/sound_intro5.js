let osc; //oscillator variable
    ...
    function setup() {
      ...
      osc = new p5.Oscillator('sawtooth'); // can be 'sine', 'triangle', 'sawtooth', 'square'
    ...
    function draw() {
      ...
      if (playing) {
        ...
        triangle(mouseX, mouseY, 300, 800, 180, 350, 30, 120); //(try changing this to a different shape!)
      } else {
